...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/vqLXvwMJV/model.json', modelLoaded);
 ...
 function gotResult(error, results){
    if(error){
        ...
        if(results[1].label=="scared"){
            document.getElementById("update_emoji_2").innerHTML="&#128562";
        }
